...
class PDFService {
  ...
  static pw.MultiPage _buildClassicTemplate(
    ...
    return pw.MultiPage(
      ...
      build: (context) => [
        ...
        // 2+3. Bill To (left) + Invoice Details (right)
        pw.Row(
          crossAxisAlignment: pw.CrossAxisAlignment.start,
          mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
          children: [
            ...
            pw.Column(
              ...
              children: [
                ...
                if (invoice.dueDate != null)
                  pw.Text("Due Date: ${_formatDate(invoice.dueDate!, datePattern)}",
                      style: const pw.TextStyle(fontSize: 10)),
              ],
            ),
          ],
  ...
  static pw.MultiPage _buildMinimalTemplate(
    ...
    return pw.MultiPage(
      pageFormat: pageFormat,
      theme: pdfTheme,
      margin: pw.EdgeInsets.all(PdfLayout.defaultHMargin), // Increased margin for more whitespace
      footer: (context) => pw.Container(
        alignment: pw.Alignment.centerRight,
        margin: const pw.EdgeInsets.only(top: 20),
        child: pw.Text(
  ...
  static pw.MultiPage _buildModernTemplate(
    ...
    return pw.MultiPage(
      ...
      build: (context) => [
        ...
        pw.Container(
          color: accentColor,
          padding: pw.EdgeInsets.only(left:PdfLayout.defaultHMargin,right: PdfLayout.defaultHMargin,top: PdfLayout.defaultVMargin,bottom: PdfLayout.defaultVMargin), // Increased padding
          child: pw.Row(
            crossAxisAlignment: pw.CrossAxisAlignment.start,
            mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
            children: [
