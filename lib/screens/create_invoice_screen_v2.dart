...
class _CreateInvoiceScreenV2State extends ConsumerState<CreateInvoiceScreenV2> {
  ...
  Future<void> _saveAdHocItemV2(InvoiceItem item) async {
    ...
    final reloaded = await ref.read(productRepositoryProvider).getAllProducts();
    if (!mounted) return;
    setState(() {
      _savedAdHocIds.add(item.product.id);
      products = reloaded;
  ...
  // ============================================================
  // End V2 additions. Original (v1) layout methods below are kept
  // unchanged and still used for the tablet/mobile breakpoints.
  // ============================================================
