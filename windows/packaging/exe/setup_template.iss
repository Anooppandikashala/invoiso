...
[Code]
// Declare SHChangeNotify from shell32.dll so we can call it directly.
// This tells Windows Explorer to flush its icon cache immediately after
// installation, so the desktop shortcut shows the correct app icon.
...
begin
  ...
  begin
    // SHCNE_ASSOCCHANGED = $08000000, SHCNF_IDLIST = $1000
